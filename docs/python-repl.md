...
2. Managed venv at `~/.zz/python-env`
...
- **No Python on PATH** — Install a system Python 3.8+ or place a venv at `~/.zz/python-env`. `zz setup python --check` reports the resolved interpreter.
