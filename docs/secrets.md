...
| Level   | Path                       | Purpose                     |
| ------- | -------------------------- | --------------------------- |
| Global  | `~/.zz/agent/secrets.yml` | Secrets across all projects |
| Project | `<cwd>/.zz/secrets.yml`   | Project-specific secrets    |
