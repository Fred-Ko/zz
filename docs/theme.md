...
- default agent dir: `~/.zz/agent`
- effective default file: `~/.zz/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.zz/agent/themes/my-theme.json`.
