 ...
 * accounts (e.g. an expired Anthropic OAuth grant) stay visible in `zz usage`
...
export class AuthStorage {
	...
	/**
	 * Disabled credential tombstones for display surfaces (`zz usage`,
	 ...
	 * per-credential data with stored identities (`zz usage`) use this so a
