 ...
 * the ZZ-wide stream watchdog removed in #1392: a WebSocket can stay TCP-open
...
/** Raw provider usage plus the normalized buckets ZZ displays for the latest Codex turn. */
