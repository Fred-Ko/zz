...
This package is the `zz` CLI. This file is a **developer's map**: where things live
...
| Build the `dist/zz` binary | `bun run build` |
...
| `advisor/`, `skills/`, `autoresearch/` | Advisor/watchdog, managed skills, background research | [advisor-watchdog.md](../../docs/advisor-watchdog.md) |
| `knowledge/` | Independent ZZ Knowledge policy, Hindsight wrapper, outbox, working sets | [knowledge.md](../../docs/knowledge.md) |
