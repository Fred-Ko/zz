...
export function getExtraHelpText(): string {
  ...
  ZZ_PROFILE                  - Named profile for isolated agent state (same as --profile)
  Use \`zz --profile <name> --alias <command>\` to create a shell shortcut for a profile
...
${chalk.bold("Useful Commands:")}
  zz agents unpack           - Export bundled subagents to ~/.zz/agent/agents (default)
  zz agents unpack --project - Export bundled subagents to ./.zz/agents`;
}
