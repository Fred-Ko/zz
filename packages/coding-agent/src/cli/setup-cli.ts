 ...
 *
 * Handles `zz setup` for onboarding and `zz setup <component>` for optional dependencies.
 */
...
// package dependencies beyond a working interpreter. `zz setup python --check`
...
/**
 * Unified `zz setup speech` flow. Drives every {@link SpeechComponent} through
