...
/**
 * Rewrite the extension-owned specifiers ZZ must host-resolve — legacy
 ...
 * realpath of every reachable source module ZZ must rewrite at load time.
...
/**
 * Linkedom's canvas bridge uses its bundled fallback because ZZ does not ship
 * native canvas.
 */
