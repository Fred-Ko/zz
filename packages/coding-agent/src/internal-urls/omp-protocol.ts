/**
 * Protocol handler for zz:// URLs, with an omp:// compatibility alias.
 *
 * Serves statically embedded documentation files bundled at build time.
 *
 * URL forms:
 * - zz:// - Lists all available documentation files
 * - zz://<file>.md - Reads a specific documentation file
 */
 ...
 */
export class ZzProtocolHandler implements ProtocolHandler {
	readonly scheme: string = "zz";
...
/** Legacy protocol alias retained for existing prompts and session transcripts. */
export class OmpProtocolHandler extends ZzProtocolHandler {
	override readonly scheme = "omp";
}
