 ...
 *
 * Utilities for reading/writing canonical `.zz/mcp.json` files at user or project level.
 */
...
export interface SetMcpServerEnabledOptions {
	 ...
	 * formats this codebase owns (native `.zz/mcp.json`, legacy `.omp/mcp.json`, and `mcp-json`
