...
export interface StdioSpawnCommand {
	 ...
	 *
	 * Windows uses this only when the ZZ host has no console to share. When
	 ...
	 * wrapper chains must stay in the ZZ console session so nested console
...
export async function resolveStdioSpawnCommand(
	...
	// same console session. Only hide the child when ZZ itself has no console
