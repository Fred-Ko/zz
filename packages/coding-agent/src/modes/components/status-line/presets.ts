...
export const STATUS_LINE_PRESETS: Record<StatusLinePreset, PresetDef> = {
	default: {
		leftSegments: ["pi", "model", "mode", "collab", "path", "worktree", "git", "pr", "context_pct", "cost"],
	...
	full: {
		leftSegments: ["pi", "hostname", "model", "mode", "path", "worktree", "git", "pr", "subagents"],
		rightSegments: [
			"session_name",
			"cache_hit",
			"token_in",
	...
	nerd: {
		...
		leftSegments: ["pi", "hostname", "model", "mode", "path", "worktree", "git", "pr", "session", "subagents"],
		rightSegments: [
			"session_name",
			"token_in",
			"token_out",
	...
	ascii: {
		...
		leftSegments: ["model", "mode", "path", "worktree", "git", "pr"],
