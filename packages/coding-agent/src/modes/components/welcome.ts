...
/**
 * Premium welcome screen with block-based ZZ logo and two-column layout.
 */
...
function introLogoFrame(progress: number): string[] {
	...
	return gradientLogo(ZZ_LOGO, phase, { strength: shineStrength, pos: shinePos });
}

/** Resting gradient frame, cached for re-renders outside of the intro. */
const REST_FRAME = gradientLogo(ZZ_LOGO, 0);
