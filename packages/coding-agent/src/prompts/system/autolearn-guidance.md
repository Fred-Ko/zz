...
You can grow a library of reusable **managed skills** with the `manage_skill` tool. Managed skills are `SKILL.md` files kept in an isolated directory (`~/.zz/agent/managed-skills`); they are surfaced to you in future sessions like any other skill.
...
- **Isolation rule:** managed skills are the ONLY skills you may write. NEVER edit user-authored skills under `~/.zz/agent/skills` or `.zz/skills`.
