 ...
 * (speech-to-text, tiny-model titles/classifiers, TTS).
 ...
 * `tts/tiny/…: worker error` lines carry the actual stack instead of a bare
...
/**
 * Drive the ping/pong readiness probe wired into `zz --smoke-test`: send one
