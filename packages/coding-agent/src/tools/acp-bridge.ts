 ...
 * updated immediately. Internal artifacts ('/Users/theo/.zz/agent/sessions/-Projects-zz/2026-06-10T09-11-41-506Z_019eb0cd-3ec2-7000-92aa-1b82aa4d78f0/local' plan files, other scheme
 * URLs) are always written directly to disk — those are ZZ-owned and should
 ...
 *
 * Returns `false` for internal-URL paths (e.g. `'/Users/theo/.zz/agent/sessions/-Projects-zz/2026-06-10T09-11-41-506Z_019eb0cd-3ec2-7000-92aa-1b82aa4d78f0/local/PLAN.md'`) and for the
 * active plan file while plan mode is enabled — both are ZZ-internal artifacts
...
export function shouldRouteWriteThroughBridge(
	...
	// ZZ-owned session artifacts (plan files, scratch notes) must stay off the
