...
const hubSchema = type({
	...
	"persist?": type("boolean").describe("start: survive the last zz client exiting; default false"),
	"detached?": type("boolean").describe(
		"start: survive every zz and broker exit; implies persist and disables PTY input",
	),
