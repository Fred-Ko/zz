...
const expectedTemplate: TemplateProbeResult = {
	chars: 377_297,
	bytes: 377_473,
	sha256: "fcaddcb09a775fd31f7399d301c65dc3612d144bab2a8a0abad2dfc3c7d2d058",
	stableCache: true,
	assetsRemoved: 0,
};
...
const tempRoot = fs.mkdtempSync(path.join(os.tmpdir(), "zz-html-template-"));
...
const bundledDependencyStubs: Record<string, string> = {
	"@oh-my-pi/pi-utils": 'export const APP_NAME = "zz"; export const isEnoent = () => false;',
	"../../modes/theme/theme":
...
describe("HTML export template", () => {
	...
	test("composes the exact source template once and returns the cached bytes", async () => {
		...
		expect(first).toContain("const THEME_STORAGE_KEY = 'zz-export-theme';");
