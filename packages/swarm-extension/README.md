...
Register the extension in your config (`~/.zz/config.json` or `.zz/config.json`):
...
Any model configured in zz works. Set a swarm default and optionally override per agent:
