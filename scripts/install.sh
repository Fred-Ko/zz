...
# ZZ Coding Agent Installer
# Usage: curl -fsSL https://raw.githubusercontent.com/Fred-Ko/zz/main/scripts/install.sh | sh
#
# Options:
...
install_via_bun() {
    ...
    echo ""
    echo "✓ Installed zz via bun"
    echo "Run 'zz' to get started!"
}
...
install_binary() {
    ...
    curl -fsSL --connect-timeout 10 --speed-limit 1024 --speed-time 30 "$BINARY_URL" -o "${INSTALL_DIR}/zz"
    ...
    # Check if in PATH
    case ":$PATH:" in
        *":$INSTALL_DIR:"*) echo "Run 'zz' to get started!" ;;
        *) echo "Add ${INSTALL_DIR} to your PATH, then run 'zz'" ;;
    esac
}
